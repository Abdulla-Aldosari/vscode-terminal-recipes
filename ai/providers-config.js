...
const AI_PROVIDERS = {
    gemini: {
        ...
        steps: [
            ...
            'Click "Create API key" and choose a project (or create a new one).',
            'Copy the generated API key.',
            'Paste it in the API Key field above and click Save.',
        ],
    },
    ...
    anthropic: {
        ...
        displayLabel: 'Anthropic Claude (claude-sonnet-4-5)',
