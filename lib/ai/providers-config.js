...
const AI_PROVIDERS = {
  gemini: {
    ...
    models: [
      { modelId: "gemini-2.0-flash",               modelLabel: "Gemini 2.0 Flash",               free: true  },
      { modelId: "gemini-2.5-flash-preview-05-20",  modelLabel: "Gemini 2.5 Flash Preview",        free: true  },
      { modelId: "gemini-2.5-pro-preview-06-05",    modelLabel: "Gemini 2.5 Pro Preview",          free: false },
    ],
  ...
  bytedancesseed: {
    name: "bytedancesseed",
    serviceName: "ByteDance Seed",
    providerName: "ByteDance",
    defaultModelId: "seed-1.6-flash",
    displayLabel: "ByteDance Seed",
    models: [
      { modelId: "seed-1.6-flash", modelLabel: "Seed 1.6 Flash", free: true },
    ],
    apiKeyUrl: "https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey",
    apiKeyUrlLabel: "Volcano Engine Console",
    steps: [
      "Go to Volcano Engine Console: <code>https://console.volcengine.com/</code>",
      "Sign in or create a ByteDance / Volcano Engine account.",
      "Navigate to <code>Ark</code> → <code>API Key</code> in the left sidebar.",
      "Click <code>Create API Key</code> and give it a name.",
      "Copy the generated API key.",
      "Paste it in the API Key field and click Save.",
    ],
  ...
  stepfun: {
    ...
    steps: [
      "Go to StepFun Platform: <code>https://platform.stepfun.com/</code>",
      "Sign in or create a StepFun account.",
      "Navigate to <code>API Keys</code> in the left sidebar.",
      "Click <code>Create</code> and give the key a name.",
      "Copy the generated API key.",
      "Paste it in the API Key field and click Save.",
    ],
  },
...
function getModelConfig(providerName, modelId) {
  ...
  if (modelId) {
    const found = provider.models.find(function (m) { return m.modelId === modelId; });
    if (found) return found;
  }
  return provider.models.find(function (m) { return m.modelId === provider.defaultModelId; }) || provider.models[0] || null;
}
